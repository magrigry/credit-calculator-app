    ...
    return (
        <Form>
            <Form.Group className="mb-3">
                ...
                <InputGroup>
                    <Form.Control type="number" min="1" placeholder="Enter credit amount" value={calculator.debt.amount} onChange={handleAmountChange} />
            ...
            <Form.Group className="mb-3">
                ...
                <InputGroup>
                    <Form.Control type="number" min={1} placeholder="Enter credit duration" value={calculator.debt.duration_in_y} onChange={handleDurationChange} />
            ...
            <Form.Group className="mb-3">
                ...
                <InputGroup>
                    <Form.Control type="number" min={0.1} step={0.1} placeholder="Enter credit rate" value={calculator.debt.credit_rate} onChange={handleCreditRateChange} />
                    <InputGroup.Text>%</InputGroup.Text>
                </InputGroup>
